...
export default function FAQTrash(props) {
  ...
  var handleDelete = async (FAQId) => {
    Delete(`${Api.FAQGetAPi}?FAQId=${FAQId}`)
      .then(handleResponse)
      .then(processUpdate)
      .catch(handleError);
  };
