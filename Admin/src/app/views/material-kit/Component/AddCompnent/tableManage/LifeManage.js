  ...
  const handleSubmit = (event) => {
    ...
    if (Lifes != '') {
      var raw = JSON.stringify({
        Author: first,
        LifeSilderimage: Lifes,
        LifeSilderTitle: LifeTitles,
        LifeSilderisActive: true
      });
      PostProcess(Api.LifeSliderPostAPi, raw)
        .then(handleResponse)
  ...
  return (
    <Container>
      <Stack spacing={3} className="container ">
        <title>Digi2l - Create Life digi2l</title>
        <div className="m-3">
          <Stack spacing={3}>
            <div class="card-headers ">
              <div class="row align-items-center">
                <div class="col">
                  <h2 class="fs-5 mb-0 card-title">Create life digi2l</h2>
                </div>
              </div>
            </div>
            <SimpleCard>
