...
const OpeningManage = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (
      ...
      PostProcess(Api.OpeningsPostApi, raw)
        .then(handleResponse)
  ...
  useEffect(() => {
    ...
    document.querySelector('#OpeningCity').addEventListener('keydown', function (e) {
      if (String.fromCharCode(e.which).match(/\d/)) {
        e.preventDefault();
      }
    });
  ...
  return (
    <Container>
      <Stack spacing={3} className="container ">
        <title>Digi2l - Create current openings </title>

        <Stack className="mt-3 mb-2" spacing={3}>
          <div class="card-headers ">
            <div class="row align-items-center">
              <div class="col">
                <h2 class="fs-5 mb-0 card-title">Create current openings </h2>
              </div>
            </div>
          </div>
          <SimpleCard title="">
                  ...
                  <div className="col-lg-12">
                    ...
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        id="OpeningExperience"
                        onChange={nameHandlerCity}
