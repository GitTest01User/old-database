...
const PartnersManage = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (DescriptionTable != '' && Testimonialimage != undefined) {
  ...
  return (
    <Container>
      <Stack spacing={3} className="container ">
        <title>Digi2l - Create partners experiences</title>

        <Stack className="mt-3" spacing={3}>
          <div class="card-headers ">
            <div class="row align-items-center">
              <div class="col">
                <h2 class="fs-5 mb-0 card-title">Create partners experiences</h2>
              </div>
            </div>
          </div>
          <SimpleCard>
