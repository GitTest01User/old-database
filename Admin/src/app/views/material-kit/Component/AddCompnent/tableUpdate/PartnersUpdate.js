...
const PartnersUpdate = () => {
  ...
  console.log(queryParams.get('partnersId'));
  var TestimonialId = queryParams.get('partnersId');
  ...
  return (
    <Container>
      <Stack spacing={3} className="container ">
        <title>Digi2l - Partners update</title>
        <div className="">
          <Stack className="mt-2" spacing={3}>
            <div class="card-headers ">
              <div class="row align-items-center">
                <div class="col">
                  <h2 class="fs-5 mb-0 card-title">Update partners experiences</h2>
                </div>
              </div>
            </div>
            <SimpleCard>
