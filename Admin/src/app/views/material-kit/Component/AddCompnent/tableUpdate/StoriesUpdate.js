...
const StoriesUpdate = () => {
  ...
  const [startDateAgreement, setStartDateAgreement] = useState('');
  ...
  console.log(queryParams.get('storiesId'));
  var StoriesId = queryParams.get('storiesId');
    ...
    $imagePreview = (
      <div className="previewText">
        <img
          class="w-100"
          id="imgprev_3_3"
          src={Stories.StoriesImage ? `${Api.BaseURL}/${Stories.StoriesImage}` : '/demo.png'}
          alt="Preview"
        />
      </div>
    );
  ...
  var datanew = Stories.StoriesImage;
  if (imagePreviewUrl) {
  ...
  const handleSubmit = async (event) => {
    ...
    var StoriesPermalinkLInk = StoriesPermalink.replace(/\s/g, '-');
    ...
    if (
      ...
      var raw = JSON.stringify({
        ...
        StoriesPermalink: StoriesPermalinkLInk,
  ...
  const processGet = (result) => {
    if (result.Status) {
      setStories(result.result[0]);
      setMarkdown(result.result[0].StoriesContent);
      const dateString = result.result[0].StoriesLaunchDate;
      const AgreementDate = result.result[0].StoriesAgreementDate;

      var Agreement = AgreementDate.replace(`T00:00:00.000Z`, '');

      setStartDateAgreement(Agreement);
      var data = dateString.replace(`T00:00:00.000Z`, '');
      setStartDate(data);
    } else {
  ...
  const fetchStoriesData = async () => {
    Get(`${Api.StoriesGetApi}?StoriesId=${StoriesId}`)
      .then(handleResponse)
      .then(processGet)
      .catch(handleError);
  };
  ...
  return (
    <Container>
      <Stack spacing={3} className="container ">
        <title>Digi2l - Update success stories </title>

        <Stack spacing={3} className="mt-3 mb-3">
          <div class="card-headers ">
            <div class="row align-items-center">
              <div class="col">
                <h2 class="fs-5 mb-0 card-title">Update success stories </h2>
              </div>
            </div>
          </div>
          <SimpleCard>
              ...
              <form onSubmit={handleSubmit} className={clicked ? 'was-validated' : ''}>
                <div className="row">
                  <div className="col-lg-6">
                    ...
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        id="StoriesTitleText"
                        ref={StoriesTitleBox}
                        defaultValue={Stories.StoriesTitle}
                  ...
                  <div className="col-lg-6">
                    ...
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        defaultValue={Stories.StoriesProgram}
                  ...
                  <div className="col-lg-6">
                    {' '}
                    <div className="mb-3">
                      <label className="mb-2">Agreement Date</label>
                      ...
                      <div className="bg-opacity-50 font-small mt-2 p-2 text-bg-light text-sm-start">
                        Agreement date is already used by default. You can change this field
                      </div>
                  ...
                  <div className="col-lg-6">
                    {' '}
                    <div className="mb-3">
                      <label className="mb-2"> Launch Date</label>
                      <input
                        type="date"
                        className="form-control mb-2 p-2 w-100"
                      ...
                      <div className="bg-opacity-50 font-small mt-2 p-2 text-bg-light text-sm-start">
                        Launch date is already used by default. You can change this field
                      </div>
                  ...
                  <div className="col-lg-12">
                    <div className="mb-3">
                      <div className="row">
                        <div className="col-lg-3 pt-3 col-md-12">
                          <div class="form-group">
                            ...
                            <input
                              ...
                              defaultValue={Stories.StoriesSponsorName}
                              onChange={SponsorHandler}
                              required
                              autoComplete="off"
                            />
                            <div class="invalid-feedback">Please fill out this field.</div>
                        ...
                        <div className="col-lg-3 pt-3 col-md-12">
                          <div class="form-group">
                            ...
                            <input
                              ...
                              defaultValue={Stories.StoriesProgramName}
                        ...
                        <div className="col-lg-3 pt-3 col-md-12">
                          <div class="form-group">
                            ...
                            <input
                              ...
                              defaultValue={Stories.StoriesPinCodes}
                        ...
                        <div className="col-lg-3 pt-3 col-md-12">
                          <div class="form-group">
                            ...
                            <input
                              ...
                              defaultValue={Stories.StoriesCityCoverage}
                  ...
                  <div className="col-lg-12">
                    <div className="mb-3 ">
                      ...
                      <input
                        ...
                        defaultValue={Stories.StoriesPermalink}
                        onChange={PermalinkHandler}
                        required
                        autoComplete="off"
                      />
                      <div className="bg-opacity-50 font-small mt-2 p-2 text-bg-light text-sm-start">
                        Permalink example -- Name
                      </div>
                    </div>
                    <div class="invalid-feedback">Please fill out this field.</div>
                  </div>
                  <div className="col-lg-12 mt-2">
                    <div id="editervalue" className="mb-3 isEmpty">
                      <label className="mb-3">
                        {' '}
                        Cantents <span style={{ color: 'red' }}>*</span>
                      </label>
                      <Editor
