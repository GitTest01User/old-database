...
const TestimonialUpdate = () => {
  ...
  var TestimonialId = queryParams.get('testimonialId');

  var textAddressBox = useRef();
  ...
  const handleSubmit = (event) => {
    ...
    var TestimonialAddress = textAddressBox.current.value;
    ...
    if (DescriptionTable != '') {
      var raw = JSON.stringify({
        ...
        TestimonialAddress: TestimonialAddress,
  ...
  return (
    <Container>
      <Stack spacing={3} className="container ">
        <title>Digi2l - Testimonial update</title>
        <div className="">
          <Stack className="mt-2" spacing={3}>
            <div class="card-headers ">
              <div class="row align-items-center">
                <div class="col">
                  <h2 class="fs-5 mb-0 card-title">Update testimonial review</h2>
                </div>
              </div>
            </div>
            <SimpleCard>
                    ...
                    <div className="col-lg-12">
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          defaultValue={Testimonial.TestimonialAddress}
                          required
                        />
                        <div class="invalid-feedback">Please fill out this field.</div>
                      </div>
