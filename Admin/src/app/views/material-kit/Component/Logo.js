...
const Logo = () => {
  ...
  const handleSubmit = () => {
    navigator(`/backend/update-logo?Id=${userDetailData.Id}`);
  };
  ...
  var LayouttapBar = () => {
    ...
    fetch('http://localhost:8000/Status/Digi2l/logo', requestOptions)
          ...
          <Stack>
            <div class="card-headers  ">
              <div class="row align-items-center">
                <div class="col">
                  <h2 class="fs-5 mb-0 card-title">Website logo</h2>
                </div>
              </div>
            </div>
            <SimpleCard>
                ...
                <div className="my-4 row">
                  <div className="row ">
                    <div className="col-md-12 mb-5 text-center">
                      <div className="editprofilepicbox mx-auto bg-light editprofilepicbox form-control-lg mx-auto">
                        <img
