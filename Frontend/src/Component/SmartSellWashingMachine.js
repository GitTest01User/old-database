...
export default function SmartSellWashingMachine() {
  ...
  const GetProdType = async () => {
    try {
      Get(`${ServerAPI.GetProductType}?catId=${2}`, token)
        .then(handleResponse)
        .then(processGetType)
        .catch(handleError);
    } catch (error) {
  ...
  const GetProdBrand = async (prodTypeId) => {
    ...
    try {
      Get(
        `${ServerAPI.GetProductBrand}?catId=${2}&productTypeid=${prodTypeId}`,
        token
      )
        .then(handleResponse)
  ...
  const GetProdTechnology = async (e) => {
    $("#ddlProductTechnology").val(0);
    try {
      Get(`${ServerAPI.GetProductTechnology}?catId=${2}`, token)
        .then(handleResponse)
  ...
  const WashingMashingRegister = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      var productCateDetails = {
        ...
        ProductCatId: 2,
        ProductCategoryData: { name: "WM", desc: "Washing Machine" },
      };
  ...
  return (
    <div>
      <title>Smart Sell Washing Machine - Digi2L</title>
      <div>
        <section
              ...
              <div className="col-md-12 mx-auto">
                <div className="wpcf7-form theme_0 smartform">
                  <Form
                    noValidate
                    validated={validated}
                    onSubmit={WashingMashingRegister}
                  >
                    <Row className="py-2 ">
                      <Form.Group
                        as={Col}
        ...
        <section
          ...
          style={{
            background:
              "linear-gradient(292deg, #ab01fc0d 0, #3325b014 100%) no-repeat padding-box",
          }}
        >
          <div className="container">
            <div className="text-center">
              <p className="lh-base mark-Bold para_first">
                Washing machines are essential appliances that help us keep our
                clothes clean and fresh. However, like any other machine, they
                can develop problems that may cause them to malfunction.
              </p>
            </div>
          </div>
        </section>
        <section className="py-1 pt-5 pb-5">
          <div className="container">
            <div className="text-center">
              <h1 className="poppins-SemiBold main_heading">
                Here are some common washing machine problems
              </h1>
              <p className="lh-base mark-Bold para_first">
                Washing Machine usually have a longer life and there are several
                common issues that can arise with a Washing Machine{" "}
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="col-lg-2 col-md-6">
                ...
                >
                  ...
                  >
                    <img
                      className="img-fluid"
                      src="/Digi2limage/problems2.png"
                      style={{ height: "100px", width: "100px" }}
                      alt=""
                    />
                  </div>
                  <p className="lh-base mark-Bold para_first">Water leaks</p>
                </div>
              </div>
              <div className="col-lg-2 col-md-6">
                <div
          ...
          <div className="row justify-content-center align-items-center">
            <div className="col-lg-6 px-xl-5 pt-3">
              <h1
                ...
                id="smartsell8"
              >
                Washing machines are designed to clean clothes efficiently and
                effectively.
              </h1>
              <p className="lh-base mark-Bold para_first">
                {" "}
                The following are the common functions of a washing machine:
              </p>
              <p className="lh-base mark-Bold para_first">
                <ul>
                  <li>Water Inlet</li>
