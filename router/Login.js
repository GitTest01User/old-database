...
router.get("/Status/Digi2l/Login", getProducts);
router.post("/Status/Digi2l/Login/Post", createProduct);
router.patch("/Status/Digi2l/Login", updateProduct);
router.delete("/Status/Digi2l/Login", deleteProduct);
router.post(
  "/Status/Digi2l/Login",
  upload.single("image"),
...
router.post(
  "/Status/Digi2l/Login/Video/upload",
  upload.single("video"),
  async (req, res) => {
    if (!req.file) {
